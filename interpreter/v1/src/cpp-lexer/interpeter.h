...
private:
  ...
  const map<string, shared_ptr<ASTNode> (*)(vector<shared_ptr<ASTNode>> &)>
      PF_FUNC_MAP = {{"plus", pf_plus},
                     ...
                     {"divide", pf_divide},
                     {"println", pf_println}};
  //                     {"equal", pf_equal},     {"nonequal", pf_nonequal},
  //                     {"less", pf_less},       {"lesseq", pf_lesseq},
  //                     {"greater", pf_greater}, {"greatereq", pf_greatereq},
  //                     {"and", pf_and},         {"or", pf_or},
  //                     {"not", pf_not},         {"xor", pf_xor},
  //                     {"eval", pf_eval},       {"isint", pf_isint},
  //                     {"isreal", pf_isreal},   {"isbool", pf_isbool},
  //                     {"isnull", pf_isnull},   {"isatom", pf_isatom},
  //                     {"islist", pf_islist},   {"head", pf_head},
  //                     {"tail", pf_tail},       {"cons", pf_cons},
  //                     {"isempty", pf_isempty}, {"foldl", pf_foldl}};
